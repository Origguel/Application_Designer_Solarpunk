...
def get_leave_animation(widget, screen_width, duration=300, delay=0, overshoot=0.6):
...
def get_enter_animation(widget, screen_width, duration=300, delay=0, overshoot=0.6):
    original_pos = widget.pos()
    offscreen_right = QPoint(screen_width + 100, original_pos.y())
...
def play_enter_exit_sequence(widget, screen_width, on_mid_callback=None, duration=1000):
    leave = get_leave_animation(widget, screen_width, duration=300, delay=0, overshoot=0.6)
    enter = get_enter_animation(widget, screen_width, duration=300, delay=100, overshoot=0.6)
